...
source_filename{1} = '../audio files/speech1.wav';
noise_filename{1} = '../audio files/Babble_noise1.wav';
...
g=[];
[y_STFT,f] = WOLA_analysis(y_TD,fs,window,nfft,noverlap,g);
[n_STFT,~] = WOLA_analysis(noise,fs,window,nfft,noverlap,g);
[x_STFT,~] = WOLA_analysis(speech,fs,window,nfft,noverlap,g);
...
s_mwfR = WOLA_synthesis(S_mvdr_mwfR_stft,window,nfft,noverlap); % To complete (time-domain version of S_mvdr_mwfL_stft)
x_mwfR = WOLA_synthesis(X_mvdr_mwfR_stft,window,nfft,noverlap); % To complete (time-domain version of X_mvdr_mwfL_stft) 
n_mwfR = WOLA_synthesis(N_mvdr_mwfR_stft,window,nfft,noverlap); % To complete (time-domain version of N_mvdr_mwfL_stft)
